export default Ember.Component.extend({
  ...
  didInsertElement: function() {
     Ember.$('.camera-lens-rating' ).append( '<span itemtype="http://schema.org/Review" itemscope=""><span itemtype="http://schema.org/Thing" itemscope="" itemprop="itemReviewed"><span itemprop="name">Camera Lens</span>Rating by</span><span itemtype="http://schema.org/Person" itemscope="" itemprop="author"><span itemprop="name">Andy</span></span><span itemtype="http://schema.org/Rating" itemscope="" itemprop="reviewRating">:<span itemprop="ratingValue">'+this.get("rating")+'</span>/<span itemprop="bestRating">10</span></span><span itemtype="http://schema.org/Organization" itemscope="" itemprop="publisher"><meta content="LensShots.com" itemprop="name"></span></span><div style="position: relative; float: left; padding-left: 3px; font-weight: bold;">Total Rating</div><div style="position: relative; float: right; padding-right: 3px; font-weight: bold;">'+this.get("rating")+'/10</div><span max="100" style="width: '+ this.get("rating")*10+'%;" id="reviewsbar" class="rating-' + Math.round(this.get("rating"))*10+ '"></span></div>' );
